...
class VideoCollectionInCell: BaseCell ,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,shareOntslohDelegate  {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.newLabel.text = "Видео мэдээ"
        cell.delegate = self
    ...
    func shareButtonClickedDelegate(sender: AnyObject) {
        ...
        delegate?.sharedClikcedVideo(item:item)
